...
public class SpellRegistry {
    ...
    public void initSpells() {
        ...
        addSpell(new Spell("Fireball", "fireball", SpellType.OFFENSE, 40, 60,
                new FlatDamageEffect(40, 60)));
        addSpell(new Spell("Ice Shard", "ice shard", SpellType.OFFENSE, 25, 15,
                new FlatDamageEffect(25, 15)));
        addSpell(new Spell("Air Slash", "air slash", SpellType.OFFENSE, 20, 10,
                new FlatDamageEffect(20, 10)));
        addSpell(new Spell("Water Beam", "water beam", SpellType.OFFENSE, 15, 5,
                new FlatDamageEffect(15, 5)));
        addSpell(new Spell("Tornado", "tornado", SpellType.OFFENSE, 30, 25,
